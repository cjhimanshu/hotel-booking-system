          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <a
                ...
                className="text-gray-400 hover:text-amber-400 transition flex items-center gap-2 mb-2"
              >
                📧 cjhimanshu49@gmail.com
              </a>
              <a
                href="tel:+919065022165"
                className="text-gray-400 hover:text-amber-400 transition flex items-center gap-2"
              >
                📞 +91 9065022165
              </a>
            </div>
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  href="https://www.instagram.com/_Himanshu_cj_/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-amber-400 transition"
